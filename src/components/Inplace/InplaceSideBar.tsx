...
function InplaceSideBar({choosePerson, members, setMembers}: any) {
    ...
    const addMemberHandler = () => {
        ...
        localStorage.setItem("I:" + maxId, JSON.stringify({maxId: 0, list: []}));
    ...
    console.log(localStorage.getItem("inplace-members"));
    return (
